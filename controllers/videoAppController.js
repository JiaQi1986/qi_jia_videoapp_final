...
exports.get_all_movies_kid = (req, res) => {
  ...
  connect.getConnection((err, connection) => {
    ...
    let query = `SELECT * FROM tbl_movies m, tbl_genre g, tbl_mov_genre mg WHERE m.movies_id = mg.movies_id AND g.genre_id = mg.genre_id AND g.genre_id IN ('3','5','6','12','13','14','16')`;
